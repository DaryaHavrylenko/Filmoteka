...
export default async function findLi() {
  ...
  function renderMarkupModal(searchValue) {
    ...
    function mark({
      ...
      let poster = '';
      if (poster_path === null) {
        poster = `src="https://yt3.ggpht.com/AAKF_677TIvjFz_9xFF0R6PgiVd0kRpEtY6APSxSDRP65nXg8hkn9NFsz2bRd9_Z37DJ9D_b=s900-c-k-c0x00ffffff-no-rj"`;
...
<div class="film-card__modal" data-modal>
  ...
  />
      ...
      <h3 class="film-card__title">${addAudit(title)}</h3>
        ...
        <tbody>
          <tr class ="about-film__info">
            ...
            <td class="about-film__characteristics">
              <span class="vote-average">${addAudit(
                vote_average.toFixed(1)
              )}</span><span class="separator">/</span
              ><span class="votes-count">${addAudit(vote_count)}</span>
            </td>
          </tr>
          <tr class ="about-film__info">
            <td class="about-film__description">Popularity</td>
            <td class="about-film__characteristics">${addAudit(
              popularity.toFixed(1)
            )}</td>
          </tr>
          <tr class ="about-film__info">
            <td class="about-film__description">Original Title</td>
            <td class="about-film__characteristics about-film__title">${addAudit(
              original_title
            )}</td>
          </tr>
          <tr class ="about-film__info">
            <td class="about-film__description">Genre</td>
            <td class="about-film__characteristics">${addAudit(gen)} </td>
          </tr>
        </tbody>
      </table>
